...
// { Start of } DB methods
    ...
    private void dropVathmologiaStoredProcedures(){
        try {psql.executeUpdate("DROP FUNCTION selVathmTwoTermsWithFinalExams();");} catch (SQLException e) {System.out.println("DROP :2 " +e.getMessage());}
        try {psql.executeUpdate("DROP FUNCTION selVathmOnePlusTwoTerms();");} catch (SQLException e) {System.out.println("DROP :3 "         +e.getMessage());}
        try {psql.executeUpdate("DROP FUNCTION selVathmFinalExams();");} catch (SQLException e) {System.out.println("DROP :4 "              +e.getMessage());}
        try {psql.executeUpdate("DROP FUNCTION selVathmSecondTerm();");} catch (SQLException e) {System.out.println("DROP :5 "+e.getMessage());}
        try {psql.executeUpdate("DROP FUNCTION selVathmFirstTerm();");} catch (SQLException e) {System.out.println("DROP :6 "+e.getMessage());}
        try {psql.executeUpdate("DROP FUNCTION selVathmStudentViaID(int);");} catch (SQLException e) {System.out.println("DROP : 7 "+e.getMessage());}
        try {psql.executeUpdate("DROP FUNCTION selVathmLessonViaID(int);");} catch (SQLException e) {System.out.println("DROP : 8 "+e.getMessage());}
    }
    
    private void createVathmologiaStoredProcedures(){
        Statement psql = dbpg.getStatement();
    ...
    private void dropMathitisStoredProcedure(){
        Statement psql = dbpg.getStatement();
    ...
    private void createMathitisStoredProcedure(){
        try {psql.executeUpdate("CREATE OR REPLACE FUNCTION showtablemathitis()\n" +
        ...
        try {psql.executeUpdate("CREATE OR REPLACE FUNCTION showtablemathitisyearly(int)\n" +
                                "returns SETOF mathitis as\n" +
                                "$$\n" +
                                "SELECT * \n" +
                                "FROM mathitis\n" +
    ...
    private void dropMathimaStoredProcedure(){
        try {psql.executeUpdate("DROP FUNCTION showtablemathima()");} 
        catch (SQLException e) {
    ...
    private void createMathimaStoredProcedure(){
        
        try {psql.executeUpdate("CREATE OR REPLACE FUNCTION showtablemathima()\n" +
